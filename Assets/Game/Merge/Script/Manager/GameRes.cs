...
namespace mygame.sdk
{
    ...
    public class DataTypeResource
    {
        ...
        public DataTypeResource(RES_type type)
        {
            this.type = type;
            this.id = 0;
        }
        public string ToKey() { return $"{type}_{id}".ToLower(); }
    }
    ...
    public enum RES_type
    {
        ...
        HEART = 2,
        TICKET = 3,
        [Tooltip("Hammer = 0, DestroyVer = 1, DestroyHor = 2, Reroll = 3")]
        BOOSTER = 4,
    }
    public class GameRes
    {
        ...
        public static bool AddRes(DataTypeResource type, int value, string desUpdate, bool isLog = true, float delayTime = 0, Action<int, int> cbAddRes = null)
        {
            string nameRes = type.type.ToString().ToLower() + "_" + type.id;
